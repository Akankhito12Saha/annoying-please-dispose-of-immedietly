var canvas;
var backgroundImage1, backgroundImage2, backgroundImage3, background1;
...
function setup() {
  ...
  background1.addImage('backy',backgroundImage1);
//blue_guy_lazy.frameDelay = 7;
...
just_dragon.addAnimation('idle',annoying_dragon);
just_dragon.scale=3;            
}
...
function draw() {
 ...
 just_dragon.velocityY = 30;

 if(keyDown("w")){
  //blue_guy.changeAnimation('move_front');
  blue_guy.velocityY = 30;
  }
